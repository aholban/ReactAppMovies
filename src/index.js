...
const restEndpoint = "http://54.90.166.125:8080/movies";
...
function RenderMoviesList({api}) {
    ...
    useEffect(() => {
        ...
        callRestApi(api, requestOptions, true)
        .then(
            result => setApiResponse(ConvertJsonMovies(result)));
    },[]);
...
function RenderActorsList({api}) {
    ...
    useEffect(() => {
        ...
        callRestApi(api, requestOptions, true)
        .then(
            result => setApiResponse(ConvertJsonActors(result)));
    },[]);
...
function RenderGenresList({api}) {
    ...
    useEffect(() => {
        ...
        callRestApi(api, requestOptions, true)
        .then(
            result => setApiResponse(ConvertJsonGenres(result)));
    },[]);
...
function ConvertJsonMovies(jsonMovies){
    ...
    const arrayOfMovies = jsonMovies.map(
        movie => <li><Link to={`/movie/${movie.film_id}`}>{movie.title}</Link></li>
    )
...
function ConvertJsonGenres(jsonGenres){
    ...
    const arrayOfGenres = jsonGenres.map(
        genre => <li><Link to={`/genre/${genre.genreID}`}>{genre.name}</Link></li>
    )
...
function ConvertJsonActors(jsonActors){
    ...
    const arrayOfActors = jsonActors.map(
        actor => <li><Link to={`/actor/${actor.actor_id}`}>{actor.firstName} {actor.lastName}</Link></li>
    )
...
const UpdateUserCredentials = (props) => {
    ...
    useEffect(() => {
        if(user1.username ==username && user1.password ==password){
            ...
            callRestApi("/login?username=" +user1.username+"&password="+user1.password, requestOptions, false)
...
const RegisterPopUp = (props)=>{
    ...
    const HandleSubmit =(event)=>{
        ...
        callRestApi("/createUser?username=" +username+"&password="+password, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
    }
...
const AddMoviePopUp = (props) => {
    ...
    const handleSubmit = (event) =>{
        ...
        callRestApi("/addMovie?username=" + user1.username +"&password="+ user1.password+ "&title=" + title+"&length="+length, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
        ...
        <div className="modal">
            <div className="modal_content">
                ...
                <form onSubmit={(event) => handleSubmit(event)}>
                    ...
                    <label>
                     Length:
                    <input type="text" name="length" value={length} onChange={handleChangeLength}/>
                    </label>
                    <br />
                    <input type="submit" />
                </form>
...
const AddActorPopUp = (props) => {
    ...
    const handleSubmit = (event) =>{
        ...
        callRestApi("/addActor?username=" + user1.username +"&password="+ user1.password+ "&first_name=" + first_name+"&last_name="+last_name, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
...
const AddGenrePopUp = (props) => {
    ...
    const handleSubmit = (event) =>{
        ...
        callRestApi("/addGenre?username=" + user1.username +"&password="+ user1.password+ "&name=" + name, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
...
const DeleteActor = () =>{
    ...
    useEffect(()=>{
        callRestApi("/deleteActor/" + id +"?username="+ user1.username +"&password=" + user1.password, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
    },[]);
...
const ActorPage = () =>{
    ...
    useEffect(()=>{
        ...
        callRestApi("/getActor/" + id, requestOptions, true)
    ...
    useEffect(() =>{
        ...
        callRestApi("/getMoviesOfActor/" + id, requestOptions, true)
    ...
    return(
        <div className="MovieContent">
            <div className="MovieHeader">
                <h1 className="MovieTitle">{actor.firstName} {actor.lastName}</h1>
                <Link to={`/actor/${id}/delete/`}><button className="MovieButtons">Delete</button></Link>
            </div>
            <h3>Movies</h3>
            <ul>
                {ConvertJsonMovies(movies)}
            </ul>
        </div>
    )
...
const DeleteGenre = () =>{
    ...
    useEffect(()=>{
        callRestApi("/deleteGenre/" + id +"?username="+ user1.username +"&password=" + user1.password, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
    },[]);
...
const GenrePage = () =>{
    ...
    useEffect(()=>{
        ...
        callRestApi("/getGenre/" + id, requestOptions, true)
    ...
    useEffect(() =>{
        ...
        callRestApi("/getMoviesByGenre/" + id, requestOptions, true)
        .then(result => setMovies(result))
    },[]);
    ...
    return(
        <div className="MovieContent">
            <div className="MovieHeader">
                ...
                <Link to={`/genre/${id}/delete/`}><button className="MovieButtons">Delete</button></Link>
            </div>
            <h3>Movies</h3>
            <ul>
                {ConvertJsonMovies(movies)}
...
const FilmPage = () => {
    ...
    useEffect(()=>{
        callRestApi("/getMovie/" + id, requestOptions, true)
        .then(result => setMovie(result))
    },[]);

    useEffect(() =>{
        callRestApi("/getGenresOfMovie/" + id, requestOptions, true)
        .then(result => setGenre(result))
    },[]);
    
    const [actors, setActors] = useState([{}]);
    useEffect(() =>{
        callRestApi("/getActorsForMovie/" + id, requestOptions, true)
    ...
    return (
        <div className="MovieContent">
            <div className="MovieHeader">
                ...
                <Link to={`/movie/${id}/delete/`}><button className="MovieButtons">Delete</button></Link>
                <button className="MovieButtons" onClick={handleUpdateButton}>Update</button>
            </div>
            <div className="MovieSubheader">
                <h3>Genres</h3>
                <button className="MovieLeftButtons" onClick={handleAddGenre}>Add genre</button>
                <button className="MovieLeftButtons" onClick={handleDeleteGenre}>Delete genre</button>
                <button className="MovieButtons" onClick={()=>rateMovie(inputRate, id)}>Rate</button>
                <input className="RateBox" type="text" placeholder="Type..." value={inputRate} onChange={e => setInputRate(e.target.value)}/>
                <p className = "Rating">{rating}</p>
            </div>
            <ul>
                {ConvertJsonGenres(genre)}
            </ul>
            <div className="MovieSubheader">
                <h3>Actors</h3>
                <button className="MovieLeftButtons" onClick={handleAddActor}>Add actor</button>
                <button className="MovieLeftButtons" onClick={handleDeleteActor}>Delete actor</button>
                <button className="MovieButtons" onClick={()=>HandleAddTrailer(inputTrailer, id, user1.username, user1.password)}>Add trailer</button>
                <input className="RateBox" type="text" placeholder="Trailer ID..." value={inputTrailer} onChange={e => setInputTrailer(e.target.value)}/>
            </div>
            <ul>
                {ConvertJsonActors(actors)}
            </ul>
            {updateMovie && <UpdateMoviePopUp toggle={handleUpdateButton}/>}
            {addGenre && <AddGenreForMovie toggle={handleAddGenre} movie_id={id}/>}
            {deleteGenre && <DeleteGenreForMovie toggle={handleDeleteGenre} movie_id={id}/>}
            {addActor && <AddActorForMovie toggle={handleAddActor} movie_id={id}/>}
            {deleteActor && <DeleteActorForMovie toggle={handleDeleteActor} movie_id={id}/>}
...
function HandleAddTrailer(input, id, username, password){
    ...
    callRestApi("/addTrailerToMovie/" + id+"?username="+username + "&password=" + password + "&trailerID=" + input, requestOptions, false)
    .then(response => {return response.text()})
    .then(text => alert(text))
}
...
const DeleteMovie = () =>{
    ...
    useEffect(()=>{
        callRestApi("/deleteMovie/" + id +"?username="+ user1.username +"&password=" + user1.password, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
    },[]);
...
const UpdateMoviePopUp = (props) => {
    ...
    const handleSubmit = (event) =>{
        ...
        callRestApi("/updateMovie/"+id+"?username=" + user1.username +"&password="+ user1.password+ "&title=" + title+"&length="+length, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
...
const AddGenreForMovie = (props) =>{
    ...
    const handleSubmit = (event)=>{
        ...
        callRestApi("/addGenreToMovie/"+props.movie_id+"?username=" + user1.username +"&password="+ user1.password+ "&name=" + genreName, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
...
const DeleteGenreForMovie = (props) =>{
    ...
    const handleSubmit = (event)=>{
        ...
        callRestApi("/deleteGenreFromMovie/"+props.movie_id+"?username=" + user1.username +"&password="+ user1.password+ "&name=" + genreName, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
...
const AddActorForMovie = (props) =>{
    ...
    const handleSubmit = (event)=>{
        ...
        callRestApi("/addActorToMovie/"+props.movie_id+"?username=" + user1.username +"&password="+ user1.password+ "&first_name=" + actorFirstName +"&last_name="+actorLastName, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
        ...
        <div className="modal">
            <div className="modal_content">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label>
                        First Name:
                        <input type="text" value={actorFirstName} onChange={handleChangeFirstName}/>
                    </label>
                    <br />
                    <label>
                        Last Name:
                        <input type="text" value={actorLastName} onChange={handleChangeLastName}/>
                    </label>
                    <br />
                    <input type="submit" />
                </form>
...
const DeleteActorForMovie = (props) =>{
    ...
    const handleSubmit = (event)=>{
        ...
        callRestApi("/deleteActorFromMovie/"+props.movie_id+"?username=" + user1.username +"&password="+ user1.password+ "&first_name=" + actorFirstName +"&last_name="+actorLastName, requestOptions, false)
        .then(response => {return response.text()})
        .then(text => alert(text))
...
class Container extends React.Component{
    ...
    handleSearchClick(){
        ...
        callRestApi("/searchMovie?title=" + this.state.searchInput, requestOptions, true)
